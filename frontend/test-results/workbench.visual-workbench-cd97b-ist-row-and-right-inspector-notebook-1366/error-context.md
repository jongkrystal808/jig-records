      ...
      - generic [ref=e33]:
        ...
        - generic [ref=e76]:
          ...
          - article [ref=e172]:
            - generic [ref=e173]:
              - generic [ref=e174]:
                - heading "治具詳細資料" [level=2] [ref=e175]
                - paragraph [ref=e176]: 請先選擇資料
              - generic [ref=e178]:
                - button "新增" [ref=e179] [cursor=pointer]
                - button "編輯" [disabled] [ref=e180]
            - generic [ref=e182]:
              - generic [ref=e183]: ⌁
              - strong [ref=e184]: 尚未選擇資料
              - paragraph [ref=e185]: 請從左側清單選擇一筆治具，即可先查看摘要；需要修改時再按「編輯」。
```
