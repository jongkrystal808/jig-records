...
Before rollout, maintain one line per deployed environment in [MIGRATION_ENVIRONMENT_INVENTORY.md](/C:/Users/user/PycharmProjects/jig-record/MIGRATION_ENVIRONMENT_INVENTORY.md).
...
1. Record the environment in [MIGRATION_ENVIRONMENT_INVENTORY.md](/C:/Users/user/PycharmProjects/jig-record/MIGRATION_ENVIRONMENT_INVENTORY.md) before the first scan.
